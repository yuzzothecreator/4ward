...
export const demoProjects: DemoProject[] = [
  {
    ...
    description:
      "A full-stack social networking platform built for university students. Features real-time messaging, event discovery, study group matching, and campus marketplace. Includes admin dashboard, push notifications, and role-based access.",
    ...
    githubRepo: "https://github.com/example/campusconnect",
  ...
  },
  {
    ...
    description:
      "Premium Figma + React Native UI kit for fintech wallets. 80+ screens, dark/light themes, micro-interactions, and complete design system tokens.",
...
export const demoUsers = [
  {
    ...
    role: "SELLER",
    university: "University of Nairobi",
    bio: "Full-stack developer & CS student. Building tools that empower African students.",
  ...
  },
  {
    ...
    role: "SELLER",
    university: "Strathmore University",
    bio: "Cybersecurity enthusiast and blockchain developer.",
  ...
  },
  {
    ...
    role: "SELLER",
    university: "Jomo Kenyatta University",
    bio: "IoT & data science builder focused on agri-tech solutions.",
